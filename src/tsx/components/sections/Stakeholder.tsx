...
const Stakeholder: React.FC<StakeholderProps> = ({ hasDesktopList = false }) => {
  const stakeholder = [
    ...
    },
    {
      ...
      description:
        'Das Projekt „Smarte Grenzregion zwischen den Meeren“ will die digitale Transformation in der Region vorantreiben, \
                 um eine integrierte und nachhaltige Stadt- und Regionalentwicklung zu gestalten und das Gemeinwohl zu stärken.',
    },
    {
      label: 'TBZ Flensburg',
      ...
      description:
        'Das Technische Betriebszentrum (TBZ) ist der zentrale Dienstleister für die Stadt Flensburg und u.a. \
                für die Pflege öffnetlicher Grünflächen, Straßenreinigung sowie Abfallwirtschaft zuständig.',
    },
  ]
  ...
  return (
    ...
    >
      <article className={`px-4 mb-8 md:px-6 lg:mb-14 ${hasDesktopList ? 'lg:text-center' : ''}`}>
        ...
        <p>
          In Zusammenarbeit zwischen der Hochschule-Flensburg, der Smarten-Grenzregion und dem
          TBZ-Flensburg soll in der Stadt Flensburg eine smarte Bewässerung für Bäume aufgebaut
          werden.
        </p>
      </article>
