...
const AdvantageCard: React.FC<AdvantageCardProps> = ({ label, description, icon }) => {
  return (
    <div className="h-full shadow-md rounded-2xl p-6 bg-green-light-900/15 group-odd:bg-green-dark-900/15 md:group-odd:bg-green-light-900/15 md:group-nth-4:bg-green-dark-900/15 md:flex md:justify-center md:items-center lg:p-8 lg:min-h-64 lg:items-center lg:justify-center">
