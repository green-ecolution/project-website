...
const HomepageOverlayIcons: React.FC<HomepageOverlayIconsProps> = ({
  ...
  const icons = [
    ...
    },
    {
      id: 2,
      figureClasses:
        'top-[calc(20%+16rem)] left-[calc(10%+20rem)] w-28 h-28 before:w-36 before:h-36 after:absolute after:w-1 after:h-56 after:-rotate-[50deg] after:-top-[170%] after:-left-[90%]',
    ...
    },
    {
      id: 4,
      figureClasses:
        'bottom-[5rem] right-[45%] w-28 h-28 before:w-36 before:h-36 after:h-2 after:max-w-[35rem] after:w-[calc(41vw-14rem)] after:right-[130%] after:origin-bottom-right after:rotate-[8deg]',
    ...
    },
    {
      id: 5,
      figureClasses:
        'bottom-[6rem] right-[22%] w-20 h-20 before:w-28 before:h-28 2xl:right-[32%] after:h-2 after:w-[13.5vw] after:right-[130%] 2xl:after:w-[5vw] 3xl:after:w-28',
    ...
    },
    {
      id: 6,
      figureClasses:
        'bottom-[6rem] right-[10%] w-16 h-16 before:w-[5.5rem] before:h-[5.5rem] 2xl:right-[20%] 3xl:right-[24%] after:h-2 after:w-[4vw] after:rotate-[3deg] after:right-[130%] 2xl:after:w-[5.5vw] 3xl:after:w-12',
    ...
    >
      {icons.map((icon, key) => (
        <figure
          key={icon.id}
          aria-hidden="true"
          className={`absolute rounded-full flex items-center justify-center transition-all duration-300 ease-in-out before:bg-white/30 before:transition-all before:duration-300 before:ease-in-out before:absolute before:-z-10 before:rounded-full after:absolute after:border-dotted after:transition-all after:duration-300 after:ease-in-out
                        ${key > 2 ? 'after:border-t-[6px] after:border-t-white' : 'after:border-l-[6px] after:border-l-white'}
                        ${icon.figureClasses}
                        ${initialDelayOver ? (icon.activeOnIndex.includes(index) ? 'bg-white before:animate-pulse before:scale-100 after:opacity-100 shadow-[0_0_40px_rgba(172,182,59,0.6)]' : 'bg-transparent before:scale-90 after:opacity-0') : 'bg-white before:animate-pulse before:scale-100 after:opacity-100'}`}
        >
          <img
            src={icon.icon}
            alt=""
