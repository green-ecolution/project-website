...
function ProjectPage() {
  ...
  return (
    <main className="relative overflow-hidden before:bg-cover before:bg-background-light-dot before:w-4/5 before:h-screen before:max-h-180 before:absolute before:-right-4 before:-top-16 before:-z-10 before:bg-no-repeat sm:before:-right-10 lg:before:max-h-220 xl:before:w-280 xl:before:-right-40 2xl:before:right-[10%] 2xl:before:bg-contain">
