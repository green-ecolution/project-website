...
describe('getTranslations', () => {
  ...
  it('kennt jeden Namespace, den das Parity-Skript prüft', () => {
    ...
    for (const namespace of namespaces) {
      const t = getTranslations('de', namespace as 'common')
