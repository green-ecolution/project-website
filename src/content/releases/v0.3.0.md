...
![Die neue Karte mit Bewässerungsgruppen als Marker in der herausgezoomten Ansicht](/assets/images/releases/v0.3.0-karte-uebersicht.png)
![Hereingezoomte Kartenansicht mit einzelnen Bäumen und der Umrandung ihrer Bewässerungsgruppe](/assets/images/releases/v0.3.0-karte-umrandung.png)
...
![Detailpanel einer Bewässerungsgruppe mit Kennzahlen und Baumliste am rechten Bildschirmrand](/assets/images/releases/v0.3.0-detailpanel.png)
...
![Übersicht der Bewässerungsgruppen als Karten-Raster mit Suche, Filtern und Statusübersicht](/assets/images/releases/v0.3.0-gruppen-uebersicht.png)
...
![Sensor-Detailseite mit der Verbindungsqualität und dem Verlauf der Empfangsstärke](/assets/images/releases/v0.3.0-sensor-signal.png)
