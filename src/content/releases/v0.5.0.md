...
highlights:
  - 'Rollen mit frei wählbaren Rechten pro Bereich'
  - 'Navigation, Seiten und Aktionen richten sich nach den Rechten'
  - 'Organisationen mit Standort und Kontaktperson'
  - 'Mitarbeitende mit Rollen, Organisation und Profil verwalten'
  - 'Ressourcen gehören einer Organisation und lassen sich übertragen'
  - 'Bewässerungsgruppen als Dashboard mit Verlauf der Wasserversorgung'
changelog:
  - type: 'feat'
    scope: 'backend'
