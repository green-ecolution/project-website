...
![Role management in the settings: the list of system roles on the left, the permissions of the Route Planning role grouped by area on the right, each with the levels None, View, Edit, and Manage](/assets/images/releases/v0.5.0-rollen-rechte.png)
...
![Organization management with the organization structure on the left and cards for basic data, location, contact person, assigned staff, and subordinate organizations on the right](/assets/images/releases/v0.5.0-organisationen.png)
...
![Staff management: the person list with a search field and filters for organization and role on the left, the cards for organization, roles, and profile on the right](/assets/images/releases/v0.5.0-mitarbeitende.png)
...
![Dashboard of an irrigation group with the four metrics, the water supply history over seven days, the irrigation history, and tiles for location and sensors](/assets/images/releases/v0.5.0-gruppen-dashboard.png)
...
![Dialog for determining soil type with input fields for sand, silt, and clay, the sample as a point in the KA5 soil texture diagram, and the result Lt2, slightly clayey loam](/assets/images/releases/v0.5.0-bodenart-ka5.png)
