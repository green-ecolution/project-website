...
![Creation form of a new irrigation group with the organization field set to TBZ and the note that dimmed trees belong to a different organization](../../../assets/releases/v0.5.1-organisationswahl-gruppe.png)
...
![Profile card in the staff management with availability, driving license classes, phone number, personnel number, and the enabled switch for selectability in operations planning](../../../assets/releases/v0.5.1-einsatzplanung-kennzeichen.png)
