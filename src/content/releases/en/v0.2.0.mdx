...
![Step 1: Scan the QR code of the sensor](/assets/images/releases/v0.2.0-sensor-workflow-1.png)
![Step 2: Assign the tree based on location](/assets/images/releases/v0.2.0-sensor-workflow-2.png)
![Step 3: Check the assignment and activate the sensor](/assets/images/releases/v0.2.0-sensor-workflow-3.png)
