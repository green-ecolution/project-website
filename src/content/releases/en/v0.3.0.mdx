...
![The new map with irrigation groups as markers in the zoomed-out view](../../../assets/releases/v0.3.0-karte-uebersicht.png)
![Zoomed-in map view with individual trees and the outline of their irrigation group](../../../assets/releases/v0.3.0-karte-umrandung.png)
...
![Detail panel of an irrigation group with metrics and tree list at the right edge of the screen](../../../assets/releases/v0.3.0-detailpanel.png)
...
![Overview of irrigation groups as a card grid with search, filters, and status overview](../../../assets/releases/v0.3.0-gruppen-uebersicht.png)
...
![Sensor detail page with the connection quality and the history of signal strength](../../../assets/releases/v0.3.0-sensor-signal.png)
