...
![Calculated route of an irrigation schedule as a line on the map, with markers for the starting point and a refill point](/assets/images/releases/v0.4.0-route-nachfuellpunkte.png)
...
![The new Kanban board for operations planning with the columns Suggestions, Planned, In Progress, and Done](/assets/images/releases/v0.4.0-einsatzplanung-board.png)
...
![Tilted 3D view of the map with the new map controls on the right edge](/assets/images/releases/v0.4.0-kartensteuerung.png)
