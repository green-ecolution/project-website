...
![Berechnete Route eines Bewässerungsplans als Linie auf der Karte, mit Markierungen für den Startpunkt und einen Nachfüllpunkt](/assets/images/releases/v0.4.0-route-nachfuellpunkte.png)
...
![Das neue Kanban-Board der Einsatzplanung mit den Spalten Vorschläge, Geplant, Unterwegs und Erledigt](/assets/images/releases/v0.4.0-einsatzplanung-board.png)
...
![Geneigte 3D-Ansicht der Karte mit der neuen Kartensteuerung am rechten Rand](/assets/images/releases/v0.4.0-kartensteuerung.png)
