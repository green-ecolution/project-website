...
In Kiel the teams first presented their projects on stage; for Green Ecolution with a look at the starting point and the vision. Then came the signatures. Signing for Green Ecolution were Dirk Schrödter, the minister for digitalization, Alexander Rosenthal (DigitalHub.SH), Malte Zinke (Digitalagentur), Inga Marken and Dr. Marcus Ott (both City of Flensburg) and Cedrik Hoffmann (PROGEEK).
